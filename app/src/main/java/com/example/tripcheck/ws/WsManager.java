package com.example.tripcheck.ws;

import com.example.tripcheck.bean.DeviceBean;
import com.example.tripcheck.bean.MessageBean;
import com.example.tripcheck.utils.LogUtils;
...
public class WsManager {
    ...
    public void init(String url, String deviceBean, final WsEventListener listener) {
        //mDeviceBean = deviceBean;
        this.listener = listener;
        this.deviceNum = deviceBean.getBytes();
